...
const imagesData = [
  {
    name: "Dragon Koi",
    type: "TAG1",
    url: "https://godevil.in/cdn/shop/products/skull-i-dont-care-white-printed-black-oversized-t-shirt-for-men-968757.jpg?v=1695318371",
  },
  {
    name: "Wolf Art",
    type: "TAG2",
  ...
  return (
    <div className="p-6 bg-gray-900 text-white">
      <div className="text-center">
        <h2 className="text-4xl font-bold mb-4">PRINTED TSHIRT</h2>
